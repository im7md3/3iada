                ...
                <div id="prt-content">
                    <div class="row g-3">
                            ...
                            <div class="box-invoice">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 p-3">
                                        ...
                                        <p><b>الرقم الطبي: {{ $diagnose->patient->id }}</b></p>
                                        <p><b>الاسم : </b>{{ $diagnose->patient->name }} </p>
                                        <p>
                                            <b>رقم الجوال: {{ $diagnose->patient->phone }}</b>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="scrl">
                                <table class="table table-invoice mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                          <td>{{ $diagnose->id }}</td>
                                          <td>{{ $diagnose->created_at->format('Y-m-d') }}</td>
                                          <td>{{ $diagnose->created_at->format('H:i A') }}</td>
                        ...
                        <div class="col-12">
                            ...
                            <h6 class="fw-bold mb-0 mt-3 fs-15px">الطبيب المعالج: {{ $diagnose->dr->name }}</h6>
                        </div>
