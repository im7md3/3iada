    ...
    <table class="table main-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div data-bs-toggle="modal" data-bs-target="#show-file" class="btn btn-purple btn-sm"><i class="fa fa-eye"></a>
                </td>
                <td>
...
{{-- Modal --}}
<div class="modal fade" id="add_file" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
