<div class="modal fade" id="delete_agent{{$sms_message->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.sms_messages.destroy',$sms_message) }}" method="POST">
                @csrf
                @method('DELETE')
