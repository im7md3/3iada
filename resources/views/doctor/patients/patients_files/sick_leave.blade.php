 <button class="btn-main-sm mb-2 " data-bs-toggle="modal" data-bs-target="#addsickLeaveFile">
     {{ __('admin.Add file') }}
 ...
 {{-- Modal --}}
 <div class="modal fade" id="addsickLeaveFile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
     <div class="modal-dialog">
