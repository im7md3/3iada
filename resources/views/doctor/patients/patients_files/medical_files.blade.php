<button class="btn-main-sm mb-2 " data-bs-toggle="modal" data-bs-target="#addmedicalFile">
    {{ __('admin.Add file') }}
    ...
    <table class="table main-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-sm btn-danger text-white" data-bs-toggle="modal" data-bs-target="#delete_agent{{ $file->id }}">
            ...
            <div class="modal fade" id="delete_agent{{ $file->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form action="{{  route('doctor.patients.medical.destroy',$file) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <div class="modal-content">
...
{{-- Modal --}}
<div class="modal fade" id="addmedicalFile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog">
        <form action="{{  route('doctor.patients.medical.store',$patient) }}" method="POST" enctype="multipart/form-data">
            @csrf
