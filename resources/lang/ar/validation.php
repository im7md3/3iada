...
return [
    ...
    'attributes'           => [
        ...
        'discount' => 'الخصم',
        'status' => 'الحالة',
        'lab_requests' => 'تسديد زيارة',
        'civil' => 'رقم الهوية',
        'first_name' => 'الاسم',
        'emerg_id' => 'رقم الطواريء',
        'phone' => 'رقم الجوال',
        'gender' => 'الجنس',
        ...
        'group' => 'المجموعة',
        'message' => 'الرسالة',
        'accounts.0.cost_center_id' => 'مركز التكلفة',
        'account_name' => 'اسم الحساب',
        'account_number' => 'رقم الحساب',
        'balance' => 'الرصيد',
        'successfully_added' => 'الرصيد',
        ...
        'product_id' => 'الخدمة',
        'start' => 'البداية',
        'scan_name_id' => 'اسم الاشعة',
        'dr_content' => 'كشف الطبيب',
        'end' => 'النهاية',
        'file_name' => 'الاسم',
        'file' => 'مرفق',
        'duration_time' => 'الوقت بالساعة',
        'duration' => 'وقت الاستئذان',
        'price' => 'السعر',
        'Message' => 'الرسالة',
        'age_type' => 'نوع العمر',
        ...
        'part' => 'جزء من الدوام',
        // 'partly' => 'دوام جزئي',
        'required_if' => 'حقل :part مطلوب عندما يكون وقت الاستئذان دوام جزئي.',
        'appointment_status' => 'حالة الموعد',
        'emergencyMarks' => 'العلامات الحيوية',
        'voucher_description' => 'وصف القسيمة',
        'accounts.*.parent_account_id' => 'الحسابات.*.الوصف',
        'accounts.*.account_id' => 'الحساب',
