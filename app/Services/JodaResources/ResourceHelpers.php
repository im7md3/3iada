...
trait ResourceHelpers
{
    public function __construct()
    {
        ...
        //         $this->middleware('permission:' . $permission)->only($routes);
        //     }
        // }
        $this->setModelName();
    ...
    public function getQuery()
    {
        if (method_exists($this, 'query')) {
            ...
            return $this->model::where(function ($query) {
                return $this->filterQueryString($query)->paginate(request()->paginate ?? 10);
            })->get();
        }
    }

    public function external($type = null)
    {
        return [];
    }
    ...
    protected function afterStore($model, $data = null)
    {
    }
    protected function afterStoreValidate($data)
    {
        return $data;
    }

    protected function afterUpdateValidate($data)
    {
        return $data;
    }
    ...
    protected function afterUpdate($model, $data = null)
    {
    }
