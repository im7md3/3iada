...
class ProgramModuleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('company.program_modules.index', compact('program_modules'));
    }
    ...
    {
        return view('company.program_modules.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('company.program_modules.index')->with('success', __('Successfully added'));
    }
    ...
    {
        return view('company.program_modules.edit', compact('program_module'));
    }
    ...
    public function update(Request $request, ProgramModule $program_module)
    {
        ...
        return redirect()->route('company.program_modules.index')->with('success', __('Successfully updated'));
    }
