...
class CountryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Country::create($data);
        return redirect()->route('admin.countries.index')->with('success', __('Successfully added'));
    }
    ...
    public function update(Request $request, Country $country)
    {
        $data = $request->validate(['name' => 'required']);
        $country->update($data);
        return redirect()->route('admin.countries.index')->with('success', __('Successfully updated'));
    }
