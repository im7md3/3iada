...
class Appointments extends Component
{
    ...
    public function render()
    {
        ...
        $appoints = Appointment::where(function ($q) {
            ...
            ->orderBy('appointment_duration','desc')
        ...
        return view('livewire.appointments', compact('appoints', 'departments', 'doctors', 'appoints_no_review', 'appoints_for_review'));
    }
    ...
    public function reminder(Appointment $appointment)
    {
        ...
        if (!in_array($response?->statusCode, [200, 201])) {
            ...
            $message = 'الرسائل النصية غير مفعلة';
